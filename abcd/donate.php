...
" name="ad2">
 ...
 <input type="text" placeholder= "For example health,food etc" cl
ass="form-control m-2" id="pwd" name="for">
 </div>
...
if(isset($_POST['submit']))
{
 ...
 $query = "insert into donate1(Name, Phone, Address, Address1, City
, State, Zip,userid,donation) values('$name','$phone', '$sad','$sad
1','$city','$state','$zip','$id','$donating')";
